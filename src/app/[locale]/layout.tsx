...
export async function generateMetadata({ params }: LocaleLayoutProps): Promise<Metadata> {
  ...
  const metadataByLocale: Record<Locale, Metadata> = {
    ...
    en: {
      ...
      description: 'Learn everything about React Hooks with live demos. Complete guide from useState, useEffect, useContext to the latest React 19 features',
      openGraph: {
    ...
    ja: {
      ...
      description: 'ライブデモと一緒にReact Hooksのすべてを学びましょう。useState、useEffect、useContextからReact 19の最新機能まで完全ガイド',
      openGraph: {
